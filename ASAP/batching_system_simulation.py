...
workloads = ['code']
code_request_rates = [1, 3, 5, 7, 8, 9]
# all_hw_node_names = ['H100',]
all_prefill_chunks = [0,  2048]
...
def run(trace, prefill_chunk):
    ...
    print(f'======{workload}_{request_rate}_{prefill_chunk} Begin =====\n')
    ...
    if os.path.exists(file_name):
        print(f'======{workload}_{request_rate}_{prefill_chunk} Exists =====\n')
        return
    ...
    sim.run()
    print(f'======{workload}_{request_rate}_{prefill_chunk} Done =====\n')
...
for workload in workloads:
    ...
    for request_rate in request_rates:
        ...
        for prefill_chunk in all_prefill_chunks:
            all_inputs.append((trace, prefill_chunk))
