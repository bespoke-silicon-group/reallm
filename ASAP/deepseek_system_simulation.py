...
def run(trace, hw_node_name):
    ...
    if workload == 'conv':
        if float(request_rate) < 3:
            end_reqs = 500
            print(f'set end_reqs to 500 for conv_{request_rate}')
        elif float(request_rate) < 5:
            end_reqs = 2000
            print(f'set end_reqs to 2000 for conv_{request_rate}')
        else:
            end_reqs = 3000
            print(f'set end_reqs to 4000 for conv_{request_rate}')
