...
for layer_idx in range(num_layers):
    if layer_idx == 0:
        qkv_weights_input = 'inputs'
    else:
        qkv_weights_input = f'ffn2_o_{layer_idx - 1}'
    # Attention layer
    ...
    qkv_node = helper.make_node(
        'MatMul',
        inputs=[qkv_weights_input, f'qkv_weights_{layer_idx}'],
    ...
    #     "MatMul",
    #     inputs=[qkv_weights_input, f'q_weights_{layer_idx}'],
    ...
    #     "MatMul",
    #     inputs=[qkv_weights_input, f'k_weights_{layer_idx}'],
