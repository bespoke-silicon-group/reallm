...
def evalServerCost(asic_spec, die_cost, hs_cost, asics_per_col, chiplets_per_board, tops_per_server, lanes_per_server, chip_id):
   ...
   if chip_id == -1:
     ...
     server_power = (275.0/2) * asics_per_col * used_lanes
   ...
   cost_all_ethernet = CONSTANTS.EthernetCost
