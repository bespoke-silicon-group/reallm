...
if __name__ == '__main__': 
    ...
    #     print('prefill latency:', generate_opt_perf.prefill_latency, 'sec')
    #     print('generate latency:', generate_opt_perf.generate_latency, 'sec')
    ...
    #     print('tco', generate_opt_perf.srv_tco.total)
        # print(generate_opt_perf.srv_tco.fix_part * num_servers, generate_opt_perf.srv_tco.power_part * num_servers, generate_opt_perf.srv_tco.fix_part * num_servers)
        # print('=================================')
